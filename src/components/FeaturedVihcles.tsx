...
export const FeaturedVihcles = () => {
  ...
  return (
    <>
      <div className="flex flex-col gap-2 justify-center items-center mb-[80px]">
      ...
      <div className="grid grid-cols-1 sm:pb-60 sm:grid-cols-3 sm:grid-rows-2 grid-rows-6 gap-y-8 px-6 pb-30 sm:gap-x-8 sm:px-40">
        {post
          ...
          .map((item) => (
            <div
              key={item._id}
              className="flex flex-col group overflow-hidden rounded-2xl shadow-xl"
            >
              <div className="relative">
                <img
                  ...
                  alt=""
                />
                <p className="absolute top-4 left-4 px-2 py-1 rounded-2xl text-white text-[12px]">
