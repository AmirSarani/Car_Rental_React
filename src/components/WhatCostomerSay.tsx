...
const WhatCostomerSay = () => {
  return (
    <div className="flex flex-col py-30 px-6 gap-24">
      <div className="flex flex-col justify-center items-center">
        <p className="text-[36px] text-center font-semibold sm:text-[40px]">
...
export default WhatCostomerSay;
